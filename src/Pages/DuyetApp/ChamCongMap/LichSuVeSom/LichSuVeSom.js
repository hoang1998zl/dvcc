...
export default function LichSuVeSom() {
  moment.locale("vi");
  let focusRef = useRef("");
  ...
  useEffect(() => {
    dvccService.getVeSomUser(token,{
  ...
  let handleSort = (value,type) => {
    ...
    if(value === "nhanvien"){
      if(type === "az"){
        array = array.sort((a,b) => a?.ns_nhanvien_dvcc_xin_ve_som_nv_idTons_nhanvien?.nv_name > b?.ns_nhanvien_dvcc_xin_ve_som_nv_idTons_nhanvien?.nv_name ? 1 : -1)
      }else{
        array = array.sort((a,b) => a?.ns_nhanvien_dvcc_xin_ve_som_nv_idTons_nhanvien?.nv_name > b?.ns_nhanvien_dvcc_xin_ve_som_nv_idTons_nhanvien?.nv_name ? -1 : 1)
      }
      ...
      if(type === "az"){
        array = array.sort((a,b) => a?.ns_nhanvien_dvcc_xin_ve_som_nguoi_duyetTons_nhanvien?.nv_name > b?.ns_nhanvien_dvcc_xin_ve_som_nguoi_duyetTons_nhanvien?.nv_name ? 1 : -1)
      }else{
        array = array.sort((a,b) => a?.ns_nhanvien_dvcc_xin_ve_som_nguoi_duyetTons_nhanvien?.nv_name > b?.ns_nhanvien_dvcc_xin_ve_som_nguoi_duyetTons_nhanvien?.nv_name ? -1 : 1)
      }
    }
    ...
    return somTreList?.slice(current*4,current*4 + 4)?.map((somTre,index) => {
      return <tr key={index} className='addRow'>
          ...
          <td className='relative'>
            <div className='flex gap-2 items-center py-2'>
              <img
                ...
                src={somTre?.ns_nhanvien_dvcc_xin_ve_som_nv_idTons_nhanvien?.nv_avatar}
                alt=""
              />
              <p className='w-max flex-1 text-left'>
                <strong>{somTre?.ns_nhanvien_dvcc_xin_ve_som_nv_idTons_nhanvien?.nv_name} </strong>
              </p>
          ...
          <td className='relative min-w-[230px]'>
            <p>{somTre?.ns_nhanvien_dvcc_xin_ve_som_nguoi_duyetTons_nhanvien?.nv_name}</p>
          </td>
          <td>
